...
import com.ubhave.sensormanager.sensors.log.InteractionSensor;
...
import com.ubhave.sensormanager.sensors.push.ActivityRecognitionSensor;
...
public class SensorUtils
{
    ...
    // added activity recognition sensor
    public final static int SENSOR_TYPE_ACTIVITY_RECOGNITION = 5027;
    ...
    public final static String ACTIVITY_RECOGNITION_ACTION = "com.ubhave.sensormanager.intent.ACTIVITY_RECOGNITION";
	public static final String INTERACTION_ACTION = "com.ubhave.sensormanager.intent.USER_GENERATED";
	...
	private static SensorInterface getSensor(int id, Context context) throws ESException
	{
		...
		case SENSOR_TYPE_INTERACTION:
			return InteractionSensor.getSensor(context);
		default:
